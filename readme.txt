...
- There is a CommandsManager for Undo/Redo. Each manipulation is a Command with "execute" and "undo" methods. (Currently, only the Enhance feature has been migrated to this system.)
